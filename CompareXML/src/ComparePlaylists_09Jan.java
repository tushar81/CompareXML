...
public class ComparePlaylists_09Jan 
{    
	...
	public static void main(final String[] args) throws IOException 
    {
		...
		File file = new File("C://TEMP//DifferencesOFPlaylist"+dateFormat.format(date) + ".txt") ;
    ...
    public static List<String> diffFiles(List<String> firstFileContent,List<String> secondFileContent) 
    {
    	...
    	Boolean flag = false; //Identify if its Content Mismatch or Sequence Mismatch
    	...
    	{	
            ...
            {	
    			if(line.trim().length() > 0)
    	            ...
    	            {
    	            	diff.add("Content Not Available in New Playlists - "+line);
    	            	flag=false;
    	            }
            }
    		if(flag)
    ...
    public static List<String> advancedDiffFiles(List<String> firstFileContent,List<String> secondFileContent) 
    {
		...
		while (It1.hasNext()&&It2.hasNext()) 
		{
			...
			{	 
				if(!L1.equals(L2))
					diff.add("DIFFERENCE in ordering - "+L1+" Not same as - "+L2);
			}
		}
    	return diff;
    }
