...
public class ComparePlaylist_Content_Sequence_25Jan 
{    
	...
	public static void main(final String[] args) throws IOException 
    {
		...
		File file = new File("C://TEMP//PlaylistXMLComparison"+dateFormat.format(date) + ".txt") ;
    	...
    	File folder = new File(OldPlaylistFolder);
