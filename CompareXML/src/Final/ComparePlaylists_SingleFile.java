...
{    
	...
	public static void main(final String[] args) throws IOException 
    {
    	...
    	//String Playlists = "780227.xml"; ASDA Playlist with creatives
		String Playlists = "750013.xml"; 
    	List<String> Result = new  ArrayList<String>();
    	   ...
    	   //Compare contents of 2 playlists with same name 
    	    if(!Playlists.isEmpty())  
    	    {
    	            ...
    	            out.write("------------------------------------------------------Complete Comparison of File 1 with File 2------------------------------------------------------");
    	            out.newLine();
    	          //Compare 2 - 1
	            	...
	            	out.write("------------------------------------------------------Complete Comparison of File 2 with File 1------------------------------------------------------");
		            out.newLine();
	    	    	}
	    	    out.close();
